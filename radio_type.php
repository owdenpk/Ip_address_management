...
if(isset($_POST['search'])){
   // header("Location:add.php");
	...
	echo $valueToSearch;
	$sql=" SELECT * FROM type_of_radio WHERE radio like '%".$valueToSearch."%'";
   ...
   // $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
	...
	$result = mysqli_query($mysqli, "SELECT * FROM type_of_radio JOIN cells ON type_of_radio.cell_id=cells.id ORDER BY cells.id DESC");
}
?>
...
<body>
	...
	<div class = "container">
		...
		<div class="align-center">
			<a class="btn btn-primary hidden-print" href="radio_add.php">Add New Radio</a><hr>
		</div>

		<table class = "table table-striped table-hover table-bordered">
			<h2 class="text text-center" >LIST OF RADIOS</h2>
			<tr>
				<th>Radio type</th>
				<th>Cell Name</th>
				<th>Created On</th>
        ...
        //while($res = mysql_fetch_array($result)) { // mysql_fetch_array is deprecated, we need to use mysqli_fetch_array 
			while($res = mysqli_fetch_array($result)) {         
				...
				echo "<td class='hidden-print'><a href=\"radio_edit.php?id=$res[id]\">Edit</a> | <a href=\"radio_delete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";       
			}
			?>
