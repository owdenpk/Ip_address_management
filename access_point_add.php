...
//including the database connection file
  ...
  if(isset($_POST['Submit'])) {    
    ...
    if(empty($name)) {                
      ...
      $result = mysqli_query($mysqli, "INSERT INTO access_point (cell_id1,name) VALUES('$cell', '$name')");
    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-primary">
        ...
        <div class="panel panel-body">
          <form action="access_point_add.php" method="post"> 
           <div class = "form-group">
            <div class="row">
              ...
              <input type = "text" class = "form-control" placeholder="Add radio" name = "name" required><br>
